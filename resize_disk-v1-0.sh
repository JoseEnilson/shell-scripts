#!/usr/bin/env bash
#
# resize_disk-v1-0.sh - Redimensionar um disco LVM existente
#
# Autor:        José Enilson Mota Silva
# Manutenção:   José Enilson Mota Silva
#
# INFO: Solicita ao usuário que informe o nome do disco a ser redimensionado.
# ------------------------------------------------------------------------ #
